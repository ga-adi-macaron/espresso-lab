...
// First Deposit description: Deposit1

        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.descriptionEditText), isDisplayed()));
        appCompatEditText.perform(replaceText("Deposit1"), closeSoftKeyboard());

        // First Deposit Amount: 870

        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.amountEditText), isDisplayed()));
        appCompatEditText2.perform(replaceText("870"), closeSoftKeyboard());
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.balanceTextView), withText("$870.00"),
                        isDisplayed()));
        textView.check(matches(withText("$870.00")));
