...
public class BalanceActivityTestWithdrawal {
    ...
    public void balanceActivityTestWithdrawal() {
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.descriptionEditText), isDisplayed()));
        appCompatEditText3.perform(replaceText("withdrawl test"), closeSoftKeyboard());
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.balanceTextView),
                        isDisplayed()));
        textView.check(matches(withText("$4.00")));
